        ...
        <div class="col-lg-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::model($department, ['action' => ['DepartmentsController@update', $department->id], 'role' => 'form', 'method' => 'PATCH', 'class'=>'form-horizontal']) !!}

                    <div class="form-group">
                        {!! Form::label('name', 'Department Name', ['class' => 'col-sm-3 control-label']) !!}
                        <div class="col-sm-9">
                            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Department']) !!}
                        </div>
                    </div>
